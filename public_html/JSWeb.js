$(function(){
    for (var i = 0; i < targyak.length; i++) {
        $("#alap").append("<tr><td>"+targyak[i].nev+"</td><td>"+targyak[i].ar+"</td><td>"+targyak[i].evjarat+"</td></tr>");
    }
...
function ujTermek() {
        ...
        $("#alap").append("<tr><td>"+ujTargy.nev+"</td><td>"+ujTargy.ar+"</td><td>"+ujTargy.evjarat+"</td></tr>");
